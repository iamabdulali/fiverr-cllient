...
const DienstleistungsauftragPage = lazy(() =>
  import("@/pages/Dienstleistungsauftrag")
);
const AdminLoginPage = lazy(() => import("@/pages/admin/Login"));
const AdminDashboardPage = lazy(() => import("@/pages/admin/Dashboard"));
const BlogEditPage = lazy(() => import("@/pages/admin/BlogEdit"));
const MemberManagementPage = lazy(() =>
  import("@/pages/admin/MemberManagement")
);
const ProtectedRoute = lazy(() => import("@/components/admin/ProtectedRoute"));
const MemberProtectedRoute = lazy(() =>
  import("@/components/member/MemberProtectedRoute")
);
...
const VertragWirdGeprueftPage = lazy(() =>
  import("@/pages/VertragWirdGeprueft")
);
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes location={location} key={location.pathname}>
              <Route path="/" element={<Layout />}>
                ...
                <Route
                  path="dienstleistungsauftrag"
                  element={<DienstleistungsauftragPage />}
                />
                <Route
                  path="vertrag-wird-geprueft"
                  element={<VertragWirdGeprueftPage />}
                />
              ...
              <Route
                path="mitglieder/auto-login"
                element={<MemberAutoLoginPage />}
              />
